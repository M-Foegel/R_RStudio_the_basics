...
![Example of a RStudio window](New_RProject.PNG)
...
![Example of panes](New_RProject_Panes.PNG)
...
![Information on the working directory](New_RProject_WD.PNG)
...
![Example of an RMarkdown file in RStudio](New_RMarkdown_file.PNG)
